...
namespace GamingWorld.API.Users.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<Users.Domain.Models.User> ListByUserIdAsync(int userId)
        {
            return await _userRepository.FindByIdAsync(userId);
        }
        
        public async Task<Users.Domain.Models.User> ListByUserUsernameAsync(int userId)
        {
            return await _userRepository.FindByIdAsync(userId);
        }

        public async Task<UserResponse> SaveAsync(Users.Domain.Models.User user)
        {
            //Validate Username
        ...
        public async Task<UserResponse> UpdateAsync(int id, Users.Domain.Models.User user)
        {
            //Validate Id
